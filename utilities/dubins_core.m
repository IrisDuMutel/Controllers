...
function param = dubins_core(p1, p2, r)
    ...
    theta = mod(atan2( dy, dx ), 2*pi);     % turns negative angles into positive ones
...
% t: first segment's adimensional length
% p: second segment's adimensional length
% q: third segment's adimensional length
